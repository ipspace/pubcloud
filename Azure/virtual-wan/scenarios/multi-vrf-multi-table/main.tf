...
resource "azurerm_virtual_hub_connection" "R1_Red_1" {
  ...
  routing {
    ...
    propagated_route_table {
      route_table_ids = [
        azurerm_virtual_hub_route_table.Red_H1.id,
        azurerm_virtual_hub_route_table.Red_H2.id
      ]
    }
  }
}
...
resource "azurerm_virtual_hub_connection" "R1_Blue" {
  ...
  routing {
    ...
    propagated_route_table {
      route_table_ids = [
        azurerm_virtual_hub_route_table.Blue_H1.id,
        azurerm_virtual_hub_route_table.Blue_H2.id
      ]
    }
  }
}
